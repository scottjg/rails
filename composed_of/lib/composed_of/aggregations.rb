  ...
  module Aggregations # :nodoc:
    ...
    module ClassMethods
      ...
      def composed_of(part_id, options = {})
        ...
        reflection = Reflection::AggregateReflection.new(:composed_of, part_id, options, self)
        add_reflection(reflection)
      end

      # Returns an array of AggregateReflection objects for all the aggregations in the class.
      def reflect_on_all_aggregations
        reflections.values.grep(Reflection::AggregateReflection)
      end
      ...
      def reflect_on_aggregation(aggregation)
        ...
        reflection if reflection.is_a?(Reflection::AggregateReflection)
      end

...
{README}[link:/rails/rails/blob/master/active_record/README.rdoc].
...
can read more about Action Pack in its {README}[link:/rails/rails/blob/master/action_pack/README.rdoc].

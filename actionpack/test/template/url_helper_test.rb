...
class UrlHelperTest < ActiveSupport::TestCase
  ...
  def test_button_to_with_remote_and_javascript_confirm_and_javascript_disable_with
    assert_dom_equal(
      "<form method=\"post\" action=\"http://www.example.com\" class=\"button_to\" data-remote=\"true\"><input data-disable-with=\"Greeting...\" data-confirm=\"Are you sure?\" type=\"submit\" value=\"Hello\" /></form>",

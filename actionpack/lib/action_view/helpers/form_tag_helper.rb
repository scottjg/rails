...
module ActionView
  ...
  module Helpers
    ...
    module FormTagHelper
      ...
      #   (by passing <tt>false</tt>).  If this is a remote form and
      #   <tt>config.action_view.embed_authenticity_token_in_remote_forms</tt> is set to false,
      #   the authenticity_token will by default not be included as the ajax handler will
      #   get it from the meta-tag (but you can force it to be rendered anyway in that case
      #   by passing <tt>true</tt>).
      ...
      private
        def html_options_for_form(url_for_options, options)
          options.stringify_keys.tap do |html_options|
            ...
            if html_options["data-remote"] && !embed_authenticity_token_in_remote_forms

...
module ActionController #:nodoc:
  ...
  class Base
    ...
    # Controls whether formatted routes should be generated by default for all resources.
    class_inheritable_accessor :formatted_routes
    self.formatted_routes = true

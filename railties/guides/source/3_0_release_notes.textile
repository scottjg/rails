...
More information: - "Make Any Ruby Object Feel Like ActiveRecord":http://yehudakatz.com/2010/01/10/active_model-make-any-ruby-object-feel-like-active_record/
...
More information: - "New Action Mailer API in Rails 3":http://lindsaar.net/2010/1/26/new-action_mailer-api-in-rails-3
...
* I18n error messages for ActiveRecord should be changed from :en.active_record.errors.template to <tt>:en.errors.template</tt>.
...
More Information:
* "New Action Mailer API in Rails 3":http://lindsaar.net/2010/1/26/new-action_mailer-api-in-rails-3

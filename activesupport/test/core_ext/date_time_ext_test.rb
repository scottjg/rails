...
class DateTimeExtCalculationsTest < ActiveSupport::TestCase
  ...
  def test_advance_partial_days
    assert_equal DateTime.civil(2012,9,28,1,15,10),  DateTime.civil(2012,9,29,13,15,10).advance(:days => 1.5)
    assert_equal DateTime.civil(2012,9,28,1,15,10),  DateTime.civil(2012,9,28,13,15,10).advance(:days => 0.5)
    assert_equal DateTime.civil(2012,9,28,1,15,10),  DateTime.civil(2012,10,29,13,15,10).advance(:days => 1.5, :months => 1)
  end

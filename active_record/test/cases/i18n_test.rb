...
class ActiveRecordI18nTests < ActiveRecord::TestCase
  ...
  def test_translated_model_attributes
    I18n.backend.store_translations 'en', :active_record => {:attributes => {:topic => {:title => 'topic title attribute'} } }
  ...
  def test_translated_model_attributes_with_sti
    I18n.backend.store_translations 'en', :active_record => {:attributes => {:reply => {:title => 'reply title attribute'} } }
  ...
  def test_translated_model_names
    I18n.backend.store_translations 'en', :active_record => {:models => {:topic => 'topic model'} }
    assert_equal 'topic model', Topic.model_name.human
  end

  def test_translated_model_names_with_sti
    I18n.backend.store_translations 'en', :active_record => {:models => {:reply => 'reply model'} }

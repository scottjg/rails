ActiveRecord::Schema.define do
  ...
  %w(postgresql_tsvectors postgresql_hstores postgresql_domains postgresql_arrays postgresql_moneys postgresql_numbers postgresql_times postgresql_network_addresses postgresql_bit_strings

...
module ActiveRecord
  ...
  class Fixtures
    ...
    def self.find_table_name(fixture_name) # :nodoc:
        ...
        connection.disable_referential_integrity do
          ...
          fixture_files = files_to_read.map do |path|
            ...
            fixtures_map[fixture_name] = new( # ActiveRecord::Fixtures.new
              connection,
              fixture_name,
              class_names[fixture_name] || find_table_name(fixture_name),
  ...
  module TestFixtures
    ...
    included do
      ...
      self.fixture_class_names = Hash.new do |h, fixture_name|
        h[fixture_name] = ActiveRecord::Fixtures.find_table_name(fixture_name)
      end
    end

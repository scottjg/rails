...
if ENV['RAILS_CI_PROJECTS']
  puts "[CruiseControl] Building Rails projects: #{ENV['RAILS_CI_PROJECTS']}"
else
...
end if ENV['RAILS_CI_PROJECTS'].nil? || ENV['RAILS_CI_PROJECTS'] =~ /activesupport/ 
...
end if ENV['RAILS_CI_PROJECTS'].nil? || ENV['RAILS_CI_PROJECTS'] =~ /railties/
...
end if ENV['RAILS_CI_PROJECTS'].nil? || ENV['RAILS_CI_PROJECTS'] =~ /actionpack/
...
end if ENV['RAILS_CI_PROJECTS'].nil? || ENV['RAILS_CI_PROJECTS'] =~ /actionmailer/
...
end if ENV['RAILS_CI_PROJECTS'].nil? || ENV['RAILS_CI_PROJECTS'] =~ /activemodel/
...
end if ENV['RAILS_CI_PROJECTS'].nil? || ENV['RAILS_CI_PROJECTS'] =~ /activeresource/
...
end if ENV['RAILS_CI_PROJECTS'].nil? || ENV['RAILS_CI_PROJECTS'] =~ /activerecord/
